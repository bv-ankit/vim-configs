...
hi Comment term=bold ctermfg=lightcyan guifg=#e7e77f
hi Constant term=underline ctermfg=Yellow guifg=#3fffa7
hi Special term=bold ctermfg=darkgreen guifg=#bfbfef
hi Identifier term=underline ctermfg=grey cterm=NONE guifg=#ef9f9f
...
hi Error term=reverse ctermfg=blue ctermbg=Black cterm=bold gui=bold guifg=Black guibg=Cyan
